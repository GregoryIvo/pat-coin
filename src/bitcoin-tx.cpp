...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s patriotcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  patriotcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded patriotcoin transaction") + "\n" +
              "  patriotcoin-tx [options] -create [commands]   " + _("Create hex-encoded patriotcoin transaction") + "\n" +
              "\n";
