...
// Copyright (c) 2022-2024 The Patriotcoin Core developers
...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Patriotcoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Patriotcoin values
        ...
        vSeeds.push_back(CDNSSeedData("multipatriot.org", "seed.multipatriot.org", true));
        vSeeds.push_back(CDNSSeedData("multipatriot.org", "seed2.multipatriot.org"));
