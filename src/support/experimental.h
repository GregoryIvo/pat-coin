...
#ifndef PATRIOTCOIN_SUPPORT_EXPERIMENTAL_H
#define PATRIOTCOIN_SUPPORT_EXPERIMENTAL_H
...
#if defined(ALLOW_PATRIOTCOIN_EXPERIMENTAL)
#define EXPERIMENTAL_FEATURES_ALLOWED 1
#else
#define EXPERIMENTAL_FEATURES_ALLOWED 0
#endif // ALLOW_PATRIOTCOIN_EXPERIMENTAL
