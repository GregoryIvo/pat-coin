...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Patriotcoin Core repository on GitHub"),
        tr("Services that claim to double your patriotcoins are always ponzi schemes")
    };
