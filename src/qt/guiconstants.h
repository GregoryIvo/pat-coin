...
#define QAPP_ORG_NAME "Patriotcoin"
#define QAPP_ORG_DOMAIN "patriotcoin.org"
#define QAPP_APP_NAME_DEFAULT "Patriotcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Patriotcoin-Qt-testnet"
