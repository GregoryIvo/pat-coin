...
/** Recommended transaction fee by Patriotcoin Core developers
  *
 ...
 *
 *  Patriotcoin:    Increment mempool limits and accept RBF in steps of 0.0001 PATRIOT
...
/**
 * Patriotcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Patriotcoin: Default hard dust limit that is evaluated when considering whether
