...
void Shutdown()
{
    ...
    RenameThread("patriotcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Patriotcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/patriotcoin/patriotcoin>";
    const std::string URL_WEBSITE = "<https://patriotcoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("patriotcoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Patriotcoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Patriotcoin: Do we need to do any RPC mining init here?
